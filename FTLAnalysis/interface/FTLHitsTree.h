...
#define DATA_CLASS_TABLE                                                \
    ...
    DATA(vector<float>, extTrack_pt)                                    \
    DATA(vector<float>, extTrack_eta)                                   \
    DATA(vector<float>, extTrack_phi)                                   \
    ...
    DATA(vector<float>, extTrack_x)                                     \
    DATA(vector<float>, extTrack_y)                                     \
    DATA(vector<float>, extTrack_z)                                     \
    DATA(vector<float>, extTrack_t)                                     \
    ...
    DATA(vector<float>, track_mcMatch_genDR)                            \
    DATA(vector<float>, track_mcMatch_simPdgId)                         \
    DATA(vector<float>, track_mcMatch_simPt)                            \
    DATA(vector<float>, track_mcMatch_simEta)                           \
    DATA(vector<float>, track_mcMatch_simPhi)                           \
    DATA(vector<float>, track_mcMatch_simDR)                              \
    ...
    DATA(map, matchedClusters_best, <int, unsigned int>)                \
